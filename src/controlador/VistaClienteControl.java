...
public class VistaClienteControl {
    ...
    public static void eliminarCliente() {
        String respuestaUsuario = VistaClienteControl.vistaCliente.mostrarDialogoConfirmacion("Esta operación es irreversible ¿Desea continuar?", "ADVERTENCIA");

        if (respuestaUsuario.equals("eliminar")) {
            ClienteVo clientePorEliminar = DialogClienteControl.getDatosCliente();
            VistaClienteControl.clienteDao.eliminarCliente(clientePorEliminar.getIdCliente());
    ...
    public static void mostrarModificarCliente() {
        String resultadoOperacion = VistaClienteControl.vistaCliente.obtenerClienteSeleccionado("Selecciona el cliente a modificar", "Modificar Cliente");
    ...
    public static void mostrarEliminarCliente() {
        String resultadoOperacion = VistaClienteControl.vistaCliente.obtenerClienteSeleccionado("Selecciona el cliente a eliminar", "Eliminar Cliente");
